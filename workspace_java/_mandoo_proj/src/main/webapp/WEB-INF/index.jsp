    ...
    <body>
        ...
        <%@ include file="header.jsp" %>
            ...
            <div class="content board">
                <h1><a href="/mandoo/boardList">사내게시판</a></h1>
                    ...
                    <tbody>
                        <c:forEach var="post" items="${posts}">
                            <tr>
                                ...
                                <td>
                                    <fmt:formatDate value="${post.boardDate}" pattern="yyyy-MM-dd" />
                                </td>
                                <td>${post.userName}</td>
                            </tr>
                        </c:forEach>
            ...
            <div id="content2">
                <h2><a href="/mandoo/ProductionStatusRead">생산현황</a></h2>
            ...
            <div class="content4">
                <div class="todo-container">
                    <h2><a href="/mandoo/todo">TodoList</a></h2>
                    <div id="addEventContainer">
                        <form id="addEventForm" action="/mandoo/todo" method="post">
                            <input type="hidden" id="hiddenDate" name="date" /> <input type="text" id="eventTitle"
                                name="title" placeholder="일정제목" required />
