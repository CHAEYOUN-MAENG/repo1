...
@Controller 				// Controller class에 붙여서 bean으로 등록시킨다
...
// @RestController 			// @Controller + @ResponseBody의 역할을 한다
@RequestMapping("/human/a") // 주소 앞에 공통으로 족용
...
//	EmpService empService;
	...
	@ResponseBody	// json으로 또는 기본타입을 돌려줌
	public EmpDTO paramTest(
			...
			// 필수있때 null인 경우 400 Bad Request 발생
			// @RequestParam을 생략하면
			...
			@RequestParam Map map, // 모든 파라메터가 key, value로 map에 넣어줌 (키-값으로 자료를 관리하는 것)
			
			@ModelAttribute EmpDTO dto1, // getParameter 꺼내서 필드에 set해서 넣어줌 
			/*
